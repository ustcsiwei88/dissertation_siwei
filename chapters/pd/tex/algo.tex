In this section, we describe three methods for solving infinite-horizon \prob (Problem~\ref{prob:1}).
...
\While{new attack events added to $E'$ }{
    Apply Alg.~\ref{alg:dp_local} to compute a plan for the defenders and attack events $E'$\;
