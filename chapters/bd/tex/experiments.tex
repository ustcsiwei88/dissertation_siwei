...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{chapters/bd/fig/timecost-v.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{chapters/bd/fig/quality-v.png}
...
Alg.~\ref{alg:bd-horizon} describes an online \ours algorithm for handling the finite horizon version of the problem where the defenders only have the information about attacks in the next $T$ time frame.
...
\begin{figure}
    \vspace{-1mm}
    \centering
    \includegraphics[width=0.98\linewidth]{chapters/bd/fig/horizon.pdf}
    \vspace{-2mm}
