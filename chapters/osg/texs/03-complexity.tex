...
gadget shown in ~\ref{fig:structure-hook} to $v \in G$ that are not 
...
~\ref{fig:rmbridge}, for a bridge $PQ$ that divides $G'$ into $G_1'$ 
...
into a {\em 3-net} is given in ~\ref{fig:3-net}.
...
one of two possible solutions outlined in ~\ref{fig:eliminter} to eliminate
