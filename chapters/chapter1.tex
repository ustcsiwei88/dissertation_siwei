...
Sensor deployment are not limited to sensors static to the ground.
...
The first set of problems studied relate to perimeter guarding with 1D sensors, where the sensing range 
