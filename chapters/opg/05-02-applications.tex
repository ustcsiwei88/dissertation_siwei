...
Castle (see ~\ref{fig:edinburgh}). The culprit remains in the confines 
...
secure a minimum length along the castle walls. ~\ref{fig:edinburgh} 
...
~\ref{fig:forest} where a forest fire has just been put out in 
...
~\ref{fig:forest} shows the optimal locations for $34$ firefighters. 
