For the three algorithms described in Section~\ref{sec:algo}, we developed
...
%
An example is given in Fig.~\ref{fig:ilpexample}.
...
retrieved from openstreetmap.org\cite{haklay2008openstreetmap}). Fig.~\ref{fig:wc} shows the 
...
shown in Fig.~\ref{fig:museum}, is computed using \orgtilp. This could be
