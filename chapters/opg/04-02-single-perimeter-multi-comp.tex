...
components $S_1, \ldots, S_q$ (e.g., Fig.~\ref{fig:opg-single-perimeter}),
...
In the example from Fig.~\ref{fig:opg-example}, $\C^*$ is partitioned into 
...
\mod q) + 1}$. As an example, see Fig.~\ref{fig:opg-tiling} where $n = 6$ 
